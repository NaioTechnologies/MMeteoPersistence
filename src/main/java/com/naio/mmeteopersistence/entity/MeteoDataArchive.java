...
@Entity
@Table(name = "meteo_data_archive")
public class MeteoDataArchive
{
	...
	@Column(name = MeteoDataArchive.PROP_ID, unique = true, length = 36)
	private String id;
	
	/** Field PROP_OWNER of type {@link String} */
    public static final String PROP_OWNER = "owner";
    /** Field owner of type {@link String} */
    @Column(name = MeteoDataArchive.PROP_OWNER)
	private String owner;
	
    /** Field PROP_TS of type {@link String} */
    public static final String PROP_TS = "ts";
    /** Field ts of type {@link Long} */
    @Column(name = MeteoDataArchive.PROP_TS)
	private Long ts;
    ...
    @Column(name = MeteoDataArchive.PROP_IMEI)    
	private String imei;
